...
Summary: Telemetry marker hooks v3 done on Claude side (tool_failure contract/action, agent_type null); Codex session check pending; S18/S19 test gaps accepted
